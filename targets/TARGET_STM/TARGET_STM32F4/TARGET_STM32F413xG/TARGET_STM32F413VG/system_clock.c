...
void enable_3v3_powersupply(void)
{
...
void SystemInit(void)
{
    ...
    SCB->VTOR = FLASH_BASE | VECT_TAB_OFFSET; /* Vector Table Relocation in Internal FLASH */
	  ...
	  enable_3v3_powersupply();


    // Enable 3V3 Power supply to have RS232 enabled (required to run tests)
//    enable_3v3_powersupply();
}
...
uint8_t SetSysClock_PLL_HSE(uint8_t bypass)
{
    ...
    RCC_OscInitStruct.PLL.PLLN            = 192;           // VCO output clock = 200 MHz (1 MHz * 200)
    RCC_OscInitStruct.PLL.PLLP            = RCC_PLLP_DIV4; // PLLCLK = 100 MHz (200 MHz / 2)
...
uint8_t SetSysClock_PLL_HSI(void)
{
    ...
    RCC_OscInitStruct.PLL.PLLN            = 192;           // VCO output clock = 200 MHz (2 MHz * 100)
    RCC_OscInitStruct.PLL.PLLP            = RCC_PLLP_DIV4; // PLLCLK = 100 MHz (200 MHz / 2)
    RCC_OscInitStruct.PLL.PLLQ            = 8;
    RCC_OscInitStruct.PLL.PLLR            = 2;
